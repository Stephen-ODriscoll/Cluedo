...
void Player::processGuessedWrong(Player* pGuesser, int cardsReceived)
{
...
void Player::recheck()
{
    ...
    {
        // Remove cards that we know the location of from doesn't have
